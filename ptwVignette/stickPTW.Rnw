...
<<knitrInitialization,echo=FALSE,message=FALSE>>=
...
\begin{figure}[tb]
\centering
<<dadProfiles,echo=FALSE,fig.width=8,fig.height=5,out.width='.9\\textwidth'>>=
library(lattice)
samp.idx <- 1
...
\begin{figure}[tb]
\centering
<<warpedProfiles,echo=FALSE,fig.height=5,fig.width=8,out.width='.9\\textwidth'>>=
samp.idx <- 13
...
\begin{figure}[tb]
  \centering
<<wccComparison,echo=FALSE,out.width='.55\\textwidth',fig.width=5,fig.height=5>>=
...
\begin{figure}[bt]
  \centering
<<warpComparison,echo=FALSE,fig.width=12,fig.height=5.5>>=
par(mfrow = c(1,2))
...
\begin{figure}[tb]
\centering
<<tics,echo=FALSE,fig.height=6,fig.width=10>>=
...
\begin{figure}[tb]
  \centering
<<warpedQCTICs,echo=FALSE,fig.height=4.5,fig.width=9>>=
par(mfrow = c(1,2))
...
\begin{figure}[tb]
\centering
<<ticsCorr,echo=FALSE,fig.height=6.5,fig.width=10>>=
